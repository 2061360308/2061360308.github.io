...
那么，我们本篇的核心是讲述装饰器，为什么要如此篇幅强调**一切皆对象**这个概念呢？


答案是：一切皆对象，函数当然也不例外。说这么多只是让为了阐述一个概念，Python中的函数也是对象，你除了直接调用它外也可以发挥想象做很多**骚操作**。
...
<center>
<img src='https://blog-image-1303709080.cos.ap-chengdu.myqcloud.com/c0134b9dab65c23e.png' alt='作用域示意图' />
</center>
